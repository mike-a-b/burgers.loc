...
<div class="wrapper">
    <div class="maincontent">
        ...
        <section class="section order" id="#6">
            <div class="container">
                        ...
                        <div class="order__form-col">
                            <div class="order__form-row order__form-row_double">
                                <label class="order__form-block">
                                    ...
                                    <input class="order__form-input" name="name" type="text" placeholder="Иван"
                                           required>
                                </label>
                                <label class="order__form-block">
                            ...
                            <div class="order__form-row order__form-row_double">
                                <label class="order__form-block">
                                    ...
                                    <input class="order__form-input" name="email" type="email"
                                           placeholder="mail@mail.ru" required>
                                </label>
                                <label class="order__form-block">
                                    <div class="order__form-label">Улица</div>
                                    <input class="order__form-input" name="street" type="text" placeholder="Ваша улица"
                                           required>
                                </label>
                            </div>
                            <div class="order__form-row order__form-row_quatro">
                                <label class="order__form-block">
                                    ...
                                    <input class="order__form-input" name="home" type="text" placeholder="№ 5" required>
                                </label>
                                <label class="order__form-block">
...
<div class="hamburger-menu" id="hamburger-menu">
    ...
    <a class="hambur    ger-menu__close" href="#">
